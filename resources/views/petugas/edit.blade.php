                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="mdd_ci" name="mdd_ci" value="{{$laporan->mdd_ci}}">
                            </div>
                            <div class="form-group">
                                <label for="tgl_ci">Tanggal CI</label>
                                <input type="date" class="form-control" id="tgl_ci" name="tgl_ci" value="{{$laporan->tgl_ci}}"required>
                            </div>
                            <div class="form-group">
                                <label for="pop_e">Pop E</label>
                                <input type="number" class="form-control" id="pop_e" name="pop_e" value="{{ $laporan->pop_e}}" required>
                            </div>
                            <div class="form-group">
                                <label for="bw_doc">BW DOC</label>
                                <input type="number" class="form-control" id="bw_doc" name="bw_doc" value="{{ $laporan->bw_doc}}" required>
                            </div>
                            <div class="form-group">
                                <label for="bw_doc">DOC</label>
                                <input type="text" class="form-control" id="doc" name="doc" value="{{ $laporan->doc}}" required>
                            </div>
                            <div class="form-group">
                                <label for="jenis_pakan">Jenis Pakan</label>
                                <input type="text" class="form-control" id="jenis_pakan" name="jenis_pakan" value="{{ $laporan->jenis_pakan}}" required>
                            </div>
                            <div class="form-group">
                                <label for="tkp_sak">TKP Sak</label>
                                <input type="number" class="form-control" id="tkp_sak" name="tkp_sak" value="{{ $laporan->tkp_sak}}" required>
                            </div>
                            <div class="form-group">
                                <label for="sp_sak">SP Sak</label>
                                <input type="number" class="form-control" id="sp_sak" name="sp_sak" value="{{ $laporan->sp_sak}}" required>
                            </div>
                            <div class="form-group">
                                <label for="terpakai">Terpakai</label>
                                <input type="number" class="form-control" id="terpakai" name="terpakai" value="{{ $laporan->terpakai}}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="umur">Umur</label>
                                <input type="number" class="form-control" id="umur" name="umur" value="{{ $laporan->umur}}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="mor_e">Mor E</label>
                                <input type="number" class="form-control" id="mor_e" name="mor_e" value="{{ $laporan->mor_e}}" required>
                            </div>
                            <div class="form-group">
                                <label for="mor">Mor</label>
                                <input type="number" class="form-control" id="mor" name="mor" value="{{ $laporan->mor}}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="ayam_hidup">Ayam Hidup</label>
                                <input type="number" class="form-control" id="ayam_hidup" name="ayam_hidup" value="{{ $laporan->ayam_hidup}}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="bw">BW</label>
                                <input type="number" step="0.001" class="form-control" id="bw" name="bw" value="{{ $laporan->bw}}" required>
                            </div>
                            <div class="form-group">
                                <label for="fi">FI</label>
                                <input type="number" step="0.01" class="form-control" id="fi" name="fi" value="{{ $laporan->fi}}"
                                    readonly>
                            </div>
                            <div class="form-group">
                                <label for="act_fcr">Act FCR</label>
                                <input type="number" step="0.01" class="form-control" id="act_fcr" name="act_fcr" value="{{ $laporan->act_fcr}}"
                                    readonly>
                            </div>
                        </div>
                        <!-- Kolom Kanan -->
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" class="form-control" id="std_fcr" name="std_fcr" value="{{ $laporan->std_fcr}}"
                                    readonly>
                            </div>
                            <div class="form-group">
                                <label for="dif">DIF</label>
                                <input type="number" step="0.01" class="form-control" id="dif" name="dif" value="{{ $laporan->dif}}"
                                    readonly>
                            </div>
                            <div class="form-group">
                                <label for="pbbh">PBBH</label>
                                <input type="number" class="form-control" id="pbbh" name="pbbh"  value="{{ $laporan->pbbh}}" required>
                            </div>

                            <div class="form-group">
                                <label for="std_pbbh">STD PBBH</label>
                                <input type="number" step="0.01" class="form-control" id="std_pbbh" value="{{ $laporan->std_pbbh}}"
                                    name="std_pbbh" readonly>
                            </div>
                            <div class="form-group">
                                <label for="progres">Progres</label>
                                <input type="number" step="1" class="form-control" id="progres" name="progres" value="{{ $laporan->progres}}"
                                    readonly>
                            </div>
                            <div class="form-group">
                                <label for="ep">EP</label>
                                <input type="number" step="1" class="form-control" id="ep" name="ep" value="{{ $laporan->ep}}"
                                    readonly>
                            </div>
                            <div class="form-group">
                                <label for="std_eph">STD EPH</label>
                                <input type="number" class="form-control" id="std_eph" name="std_eph" value="{{ $laporan->std_eph}}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="progres2">Progres 2</label>
                                <input type="number" step="1" class="form-control" id="progres2" value="{{ $laporan->progres2}}"
                                    name="progres2" readonly>
                            </div>
                            <div class="form-group">
                                <label for="suhu">Suhu</label>
                                <input type="number" class="form-control" id="suhu" name="suhu" value="{{ $laporan->suhu}}" required>
                            </div>
                            <div class="form-group">
                                <label for="rh">RH</label>
                                <input type="number" class="form-control" id="rh" name="rh" value="{{ $laporan->rh}}" required>
                            </div>
                            <div class="form-group">
                                <label for="hi">HI</label>
                                <input type="number" class="form-control" id="hi" name="hi" value="{{ $laporan->hi}}" readonly>
                            </div>
                            <div class="form-group">
                                <label for="kepadatan">kepadatan</label>
                                <input type="number" class="form-control" id="kepadatan" name="kepadatan" value="{{ $laporan->kepadatan}}" required>
                            </div>
                            <div class="form-group">
                                <label for="tra">tra</label>
                                <input type="number" class="form-control" id="tra" name="tra" value="{{ $laporan->tra}}" required>
                            </div>
                            <div class="form-group">
                                <label for="tma">tma</label>
                                <input type="number" class="form-control" id="tma" name="tma" value="{{ $laporan->tma}}" required>
                            </div>
                            <div class="form-group">
                                <label for="treatment_ovk">treatment ovk</label>
                                <input type="text" class="form-control" id="treatment_ovk" name="treatment_ovk" value="{{ $laporan->treatment_ovk}}"
                                    required>
                            </div>
                            <div class="form-group">
                                <label for="kondisi">Kondisi</label>
                                <input type="text" class="form-control" id="kondisi" name="kondisi" value="{{ $laporan->kondisi}}" required>
                            </div>
                            <div class="form-group">
                                <label for="saran">Saran</label>
                                <input type="text" class="form-control" id="saran" name="saran" value="{{ $laporan->saran}}" required>
                            </div>
                        </div>
                    </div>
                </div>
