                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="doc" name="doc" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <label for="sp_sak">@livewireScripts Sak</label>
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" class="form-control" id="pbbh" name="pbbh"
                                    required>
                            </div>
                            <div class="form-group">
